...
# Dictionary of room id numbers, as numeric keys, each key maps to:
#   List of two objects:
#       A tuple representing (x, y) coordinates
#       A dictionary of direction strings, mapped to    
#           room id numbers
roomGraph={
    494: [(1, 8), {'e': 457}],
    492: [(1, 20), {'e': 400}],
...
test_traverser = Traverser(player)
traversalPath =  test_traverser.traverse()
